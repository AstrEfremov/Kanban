package com.example.KanbanAndCalendar.controllers;

import com.example.KanbanAndCalendar.controllers.dto.kanban.KanColumnDTO;
import com.example.KanbanAndCalendar.controllers.dto.kanban.ProjectDTO;
import com.example.KanbanAndCalendar.controllers.dto.kanban.TaskDTO;
...
import com.example.KanbanAndCalendar.services.CalendarService;
import com.example.KanbanAndCalendar.services.KanbanService;
...
@RestController
@AllArgsConstructor
@RequestMapping(value = "/v1/public/projects", produces = MediaType.APPLICATION_JSON_VALUE)
